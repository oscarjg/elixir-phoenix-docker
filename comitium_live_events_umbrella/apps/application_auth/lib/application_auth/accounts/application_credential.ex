defmodule ApplicationAuth.Accounts.ApplicationCredential do
  use Ecto.Schema
  import Ecto.Changeset

  @spec allowed_hosts_to_enum(ApplicationAuth.Accounts.ApplicationCredential.t()) :: Enum.t()
  ...
  schema "application_credentials" do
    ...
    belongs_to(:application, ApplicationAuth.Accounts.Application)
